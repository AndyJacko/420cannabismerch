...
$prodsql = "SELECT * FROM tbl_products WHERE prod_cat = 10 ORDER BY tbl_id DESC";
...
<html><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta property="og:title" content="Rolling Papers | Cones | Rolling Machines">
    <title>Rolling Papers | Cones | Rolling Machines</title>
    <!-- InstanceEndEditable -->
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <section id="content" class="col-lg-10">
          ...
          <p>&nbsp;</p>
          <p>Rolling Papers | Cones | Rolling Machines.</p>
