...
$prodsql = "SELECT * FROM tbl_products WHERE prod_cat = 6 ORDER BY tbl_id DESC";
...
<html><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta property="og:title" content="Pipes | Chillums | Shisha">
    <title>Pipes | Chillums | Shisha</title>
    <!-- InstanceEndEditable -->
