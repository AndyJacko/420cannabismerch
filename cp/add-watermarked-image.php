...
if(strlen($large_photo_exists)>0 && strlen($thumb_photo_exists)>0){
  ...
  $newfile = '../images/gallery/'.$usrCode.'.jpg';
  ...
  unlink("../images/temp/thumbnail_pic.jpg");
	...
	$im = imagecreatefromjpeg('../images/gallery/'.$usrCode.'.jpg');
    ...
    imagejpeg($im,'../images/gallery/'.$usrCode.'.jpg',90);
	unset($_SESSION['popo']);
  header("location: view-watermarked-images.php");
}
?>
<!doctype html>
<html>
  ...
  <title>Add Watermarked Image</title>
...
<?php
              ...
              <?php }?>
              <h1>Create New Watermarked Image For Sharing</h1>
              <?php
                  if (strlen($error) > 0) {
                  ...
                  if (strlen($large_photo_exists )> 0) { ?>
              <h2>Create Watermarked Image</h2>
              <br><br>
              <div align="center">
                ...
                <form name="thumbnail" action="" method="post">
                  ...
                  <br>
                  <input type="submit" name="upload_thumbnail" value="Save Image" id="save_thumb" class="btn btn-default">
                </form>
              </div>
              <hr />
              <?php } ?>
