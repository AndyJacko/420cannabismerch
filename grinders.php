...
$prodsql = "SELECT * FROM tbl_products WHERE prod_cat = 11 ORDER BY tbl_id DESC";
...
<html><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta property="og:title" content="Herb Grinders | Pollen Catchers | Sifter Grinders">
    <title>Herb Grinders | Pollen Catchers | Sifter Grinders</title>
    <!-- InstanceEndEditable -->
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <section id="content" class="col-lg-10">
          ...
          <p>&nbsp;</p>
          <p>Herb Grinders | Pollen Catchers | Sifter Grinders.</p>
