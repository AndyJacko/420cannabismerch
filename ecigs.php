...
$prodsql = "SELECT * FROM tbl_products WHERE prod_cat = 9 ORDER BY tbl_id DESC";
...
<html><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta property="og:title" content="E-Cigs | E-Cigars | Mods">
    <title>E-Cigs | E-Cigars | Mods</title>
    <!-- InstanceEndEditable -->
