...
$prodsql = "SELECT * FROM tbl_products WHERE prod_cat = 5 ORDER BY tbl_id DESC";
...
<html><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta property="og:title" content="Bongs | Water Pipes | Rigs">
    <title>Bongs | Water Pipes | Rigs</title>
    <!-- InstanceEndEditable -->
