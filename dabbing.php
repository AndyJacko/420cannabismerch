...
$prodsql = "SELECT * FROM tbl_products WHERE prod_cat = 8 ORDER BY tbl_id DESC";
...
<html><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta property="og:title" content="Dab Rigs | Nails | Torches">
    <title>Dab Rigs | Nails | Torches</title>
    <!-- InstanceEndEditable -->
