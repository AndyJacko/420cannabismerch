...
$prodsql = "SELECT * FROM tbl_products WHERE prod_cat = 1 ORDER BY tbl_id DESC";
...
<html><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta property="og:title" content="Men's Cannabis T-Shirts | Men's Cannabis TShirts | Men's Cannabis Tees">
    <title>Men's Cannabis T-Shirts | Men's Cannabis TShirts | Men's Cannabis Tees</title>
    <!-- InstanceEndEditable -->
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <section id="content" class="col-lg-10">
          ...
          <h1>Mens <br class="visible-xs">Cannabis T-Shirts</h1>
          ...
          <p>&nbsp;</p>
          <p>Mens cannabis t-shirts, marijuana t-shirts.</p>
