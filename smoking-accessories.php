...
$prodsql = "SELECT * FROM tbl_products WHERE prod_cat = 12 ORDER BY tbl_id DESC";
...
<html><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta property="og:title" content="Smoking Accessories | Scales | Ashtrays">
    <title>Smoking Accessories | Scales | Ashtrays</title>
    <!-- InstanceEndEditable -->
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <section id="content" class="col-lg-10">
          ...
          <p>&nbsp;</p>
          <p>Smoking Accessories | Scales | Ashtrays.</p>
